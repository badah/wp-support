...
class FaqCategorias extends \acf_field
{
    /**
    ...
    public function __construct($data)
    {
        ...
        $this->name = 'componente_faq_categorias';

        // Label (string) Multiple words, can include spaces, visible when selecting a field type.
        $this->label = __('Categorias de FAQ', Core::PLUGIN_NAME);
    ...
    {
        new View('faq-categorias', $this->data);
    }
}
